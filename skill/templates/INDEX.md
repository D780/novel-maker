...
| 模板 | 用途 | 使用时机 | 必填字段 |
|------|------|---------|---------|
| [constitution.md](constitution.md) | 创作宪法 | `/nw init` 时创建,持续更新 | 书名/题材/文风/核心原则 |
| [outline.md](outline.md) | 总大纲 | `/nw plan` 时生成 | 作品基因/角色/世界观/分卷 |
| [chapter.md](chapter.md) | 章节模板 | `/nw write` 时使用 | 大纲目标/本章核心/正文 |
...
| 模板 | 用途 | 使用时机 |
|------|------|---------|
| [volume-plan.md](volume-plan.md) | 卷计划 | `/nw plan 规划第X卷` 时 |
| [act-plan.md](act-plan.md) | 幕计划 | `/nw act` 时自动生成 |
...
| [review-report.md](review-report.md) | 审查报告 | `/nw review` 时 |
