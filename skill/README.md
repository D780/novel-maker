...
# 或手动安装
cp -r skill/ .trae/skills/novel-weaver/  # Trae
cp -r skill/ .claude/skills/novel-weaver/  # Claude Code
```
...
| 指令 | 用途 |
|------|------|
| `/novel-weaver init` | 初始化项目 |
| `/novel-weaver write` | 写/续写章节 |
| `/novel-weaver review` | 审查质量 |
| `/novel-weaver plan` | 生成大纲 |
| `/novel-weaver act` | 幕规划 |
| `/novel-weaver memory` | 查看设定 |
| `/novel-weaver help` | 帮助 |
